...
GET [https://backend-payment-module.onrender.com/api/payments/](https://backend-payment-module.onrender.com/api/payments/)
...
Supports **partial and full refunds**. Refund records are stored in a separate refunds table.
